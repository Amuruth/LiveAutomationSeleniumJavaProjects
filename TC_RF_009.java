...
public class TC_RF_009 {
	...
	@Test
	public void verifyRegisteringAccountUsingExisintEmail() {
		...
		//Assert.assertTrue(driver.findElement(By.xpath("//div[@class='alert alert-danger alert-dismissible'][text()='Warning: E-Mail Address is already registered!']")).isDisplayed());
