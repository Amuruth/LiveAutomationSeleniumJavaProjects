...
public class TC_RF_12 {
	...
	@Test
	public void verifyRegiteringAccountByUsingtheKeyboardKeys() {
		...
		.sendKeys(Keys.TAB).pause(Duration.ofSeconds(1)).sendKeys("jannu")
        .sendKeys(Keys.TAB).pause(Duration.ofSeconds(1)).sendKeys(CommonUtils.generteBrandNewEmail())
